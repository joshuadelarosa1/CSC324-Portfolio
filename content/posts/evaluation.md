+++
date = '2026-04-15T13:46:09-05:00'
draft = false
title = 'Evaluation'
+++
...
I have attached an image with my notes of the observation/results of questions that I asked the user. I forgot to upload it directly to a GitHub repo, but spoke about the results with my team members to try to come up with solutions together. I did not use AI in the process of summarizing notes or creating a design plan for the evaluation. This demonstrates my completion of the competency because I was able to 1. evaluate specific portions of GrinnSim by using a user study (one peer who did a playthrough), 2. gain results/general observations from the study (ambiguiety, confusion overall) and 3. adapt what to do in future development based on the results. 